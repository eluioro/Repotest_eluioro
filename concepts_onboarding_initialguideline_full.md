...
and [README.md](https://github.com/WorldHealthOrganization/tng-participant-template/blob/main/README.md).
 ...
 A [Diagram](https://github.com/WorldHealthOrganization/smart-trust/blob/docs/OnboardingProcess_Documents/input/images/OnboardInitial_Full.png) that gives and overview about the steps in order to start the Full Onboarding.
